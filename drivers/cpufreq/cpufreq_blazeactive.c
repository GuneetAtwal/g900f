 ...
 * Copyright (C) 2013-2014 GuneetAtwal <guneetatwal@gmail.com>
...
MODULE_DESCRIPTION("'cpufreq_blaze' - A cpufreq governor for "
	"Latency sensitive workloads based on interactive");
MODULE_LICENSE("GPL");
